            ...
            <div className="flex flex-col md:flex-row gap-16 items-center">
              <div className="md:flex-1 min-w-0 break-words whitespace-normal text-[#EB5F0A] text-md font-mono leading-relaxed">
                <p className="">
                  ...
                  Universidade do Minho no ano lectivo de 1976-77. Pioneiro no
            ...
            <div className="flex flex-col md:flex-row-reverse gap-16 items-center">
              <div className="md:flex-1 min-w-0 text-[#EB5F0A] text-md font-mono leading-relaxed">
                <p className="break-words whitespace-normal">
                  Entretanto, a oferta cresceu e diversificou-se. Alguns ramos,
                  como os Sistemas de Informação, consolidaram-se em novos
                  departamentos, outros autonomizaram-se em novos projectos,
                  como as Comunicações e, mais recentemente, as Ciências de
                  Dados, a Informática Médica, a Inteligência Artificial, a
                  Segurança da Informação ou a Computação de Alto Desempenho.
                  Cursos de fronteira surgiram em diálogo com outros domínios do
                  saber, como a Bioinformática e a Engenharia Física, esta
                  última igualmente pioneira no ensino da computação quântica.
                </p>
                <br />
                <p>
                  Simultaneamente, uma forte e consistente dimensão de
                  investigação, com elevado nível de internacionalização, veio
                  escudar o vertiginoso desenvolvimento da Informática nesta
                  Casa. Desde o início, também aí, fomos pioneiros: em 1995 o
                  Departamento de Informática organizou a primeira conferência
                  nacional em WWW, alojou a primeira página institucional de
                  Portugal, e daqui saiu a primeira mensagem de e-mail.
                </p>
              </div>
            ...
            <div className="flex flex-col md:flex-row gap-16 items-center">
              <div className="md:flex-1 min-w-0 text-[#EB5F0A] text-md font-mono leading-relaxed">
                <p className="break-words whitespace-normal">
                  ...
                  reconhecida, hoje enquadrada no Algoritmi e no INESC TEC;
                  aposta consistente na inovação, no empreendedorismo e no
                  diálogo com o tecido empresarial.
                </p>
                <br />
                <p>
                  Este último pilar é constitutivo, desde o início, do código
                  genético da Informática na UMinho. Concretizando o célebre
                  aforismo de E. W. Dijkstra, procuramos levar à indústria não
                  tanto o que ela quer, mas o que de facto precisa. E fazer, em
                  conjunto, esse caminho.
                </p>
                <br />
                <p>
                  Assim se explica o vibrante ecossistema de inovação que é
                  imagem de marca da Informática na UMinho. Caminho iniciado
                  logo na década de 1970, com a criação da Datamatic, e
                  continuado hoje com empresas fundamentais, em domínios que vão
                  da segurança à sustentação da vida, do processamento de
                  documentos às bases de dados distribuídas, dos agentes
                  inteligentes à engenharia de dados.
                </p>
              </div>
